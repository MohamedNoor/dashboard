  ...
  componentDidMount(){
    ...
    .then(res => {
          ...
          results.forEach(element => {
            ...
            pct_uplift.push(element.pct_uplift);
            //results are looped , each element of the pct_uplift data is pushed into an empty array
          });
          this.setState({
            //state is changed
          Data: {
        ...
        {/*section for the bar graph*/}
          <article className="canvas-container">
            <Bar
              ...
              title: {
              display: true,
              text: "Table that show % Uplift compared to the Metric",
              fontSize: 22
              }
              }}
            />
